...
- Оформление заказа -требует доработки

- Дизайн -тредует доработки
...
- Загрузка изображение -необходимо протестировать

- Редактирование пользователей -необходимо протестировать
